...
internal class Program {
    static void Main(string[] args) {
        ...
        Console.WriteLine("Player 1 is called " + playerOneName + " (X), Player 2 is called " + playerTwoName + " (0).");
        ...
        while (gameRunning) {
            ...
            for (int i = 0; i < 8; i += 3) {
                ...
                Console.WriteLine(idxToChar[line] + " | " + lineFields[0] + " | " + lineFields[1] + " | " + lineFields[2] + " |");
                Console.WriteLine("  -------------");
                line++;
            }

            Console.Write(currentPlayerName + " it's your turn. Select a position by writing 'column,row' (e.g. 'a,1'): ");
            ...
            if ((inputColumn != "a" && inputColumn != "b" && inputColumn != "c") || inputRow < 1 || inputRow > 3) {
                Console.WriteLine("Bad input, try again!");
                System.Threading.Thread.Sleep(2000);
                continue;
            }
            ...
            foreach (int[] subList in lists) {
                ...
                for (int idx = 0; idx < 3; idx++) {
                    if (fields[subList[idx]] == nextPlayer) fieldsFound++;
                }

                if (fieldsFound == 3) gameWon = true;
            }
            ...
            if (gameWon || gridIsFull) {
                ...
                if (wonInput == "quit") {
                    gameRunning = false;
                    Console.WriteLine("***Quitting game, goodbye " + playerOneName + " and " + playerTwoName + ".");
                }
            } else {
